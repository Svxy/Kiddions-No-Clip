...
local function NoClip(e)
	...
	if e then 
		...
		forward_hotkey = menu.register_hotkey(87, forward)
		backward_hotkey = menu.register_hotkey(83, backward)
		turnleft_hotkey = menu.register_hotkey(65, turnleft)
		turnright_hotkey = menu.register_hotkey(68, turnright)
